...
<div class="flex flex-1 flex-col gap-6 px-12 pt-[125px] pb-12 bg-black/75">
    <div class="flex flex-col lg:flex-row gap-6 w-full">
        ...
        {:else}
            <div class="w-full lg:w-2/3">
                ...
                ></div>
                <div
                    class="card flex-row items-center gap-2 mx-6 -mt-8 px-5 bg-white text-xl h-[60px] animate-pulse"
                >
                    <svg
                        role="img"
                        viewBox="0 0 24 24"
                    ...
                    <span class="truncate">
                        Loading main video thumbnail, please wait...
                    </span>
                </div>
            </div>
        {/if}
            ...
            {:else}
                {#each Array(5) as _, i}
                    <div class="flex flex-1 gap-3 w-full">
                        ...
                        ></div>
                        <div
                            class="flex-1 text-white xl:text-lg line-clamp-3 h-[4.5em] overflow-hidden"
                        >
                            Loading video thumbnail #{i + 2}
                        </div>
                    </div>
                {/each}
            {/if}
